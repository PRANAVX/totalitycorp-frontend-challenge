    ...
    <div class="nav-container">
      <nav className="nav">
        <ul className="nav-large">
            <li className="nav-item"><img className="nav-logo"src="/images/icons/apple.svg" alt="apple logo"></img></li>
            ...
            <li className="nav-item"><img className="nav-logo"src="/images/icons/search.svg" alt="Search logo"></img></li>
            <li className="nav-item"><img className="nav-logo"src="/images/icons/bag.svg" alt="bag logo"></img></li>
        </ul>
      </nav>
    </div>
  )
